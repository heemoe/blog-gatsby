...
description: Why Flask-RESTful may return an internal server error when JSON data includes unserializable values.
date: 2016-05-05T02:26:49Z
draft: false
slug: fask-restful-api-return-internal-server-error
tags:
  - python
---
